...
function fixAppJs(filepath) {
  ...
  // Replace everything from window.imprimirPadrao to the end of the file.
  // We assume these are at the bottom of the file since we just appended them earlier.
...
function getCommonHeader(subtitle) {
  return \`
    <div style="display:flex; justify-content:space-between; align-items:flex-end; border-bottom:2px solid #000; padding-bottom:10px; margin-bottom:15px; width:100%; font-family: Arial, sans-serif;">
      <img src="img/logo-seduc.png" style="height:55px;">
      <div style="text-align:right;">
        <h2 style="margin:0 0 4px 0; font-size:16px; color:#000;">CAM - COORDENADORIA DE ARTICULAÇÃO COM OS MUNICÍPIOS</h2>
        <div style="font-size:12px; color:#000; font-weight:bold;">\${subtitle.toUpperCase()}</div>
      </div>
    </div>
  \`;
}
...
function getCommonFooter() {
  return \`
    <div style="border-top:1px solid #000; padding-top:5px; margin-top:20px; display:flex; justify-content:space-between; font-size:10px; font-weight:bold; color:#000; font-family: Arial, sans-serif;">
...
window.imprimirDetalhado = function() {
  ...
  const html = \`
    <table style="width:100%; font-family: Arial, sans-serif;">
      ...
      <tfoot><tr><td>\${getCommonFooter()}</td></tr></tfoot>
    </table>
  \`;
...
window.imprimirAnalise = function() {
  ...
  // Cruzamento Status vs Localizacao
  const analise = {};
  ...
  const html = \`
    <table style="width:100%; font-family: Arial, sans-serif;">
      ...
      <tbody><tr><td>
        ...
        <div style="margin-bottom:20px; font-size:12px; text-align:justify; line-height:1.6; background:#f1f5f9; padding:15px; border:1px solid #ccc;">
