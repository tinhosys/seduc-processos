...
const AGRUPAMENTOS_REGIONAIS = {
  ...
  "Nova Brasil�ndia D'Oeste": "Zona da Mata",
  "Novo Horizonte do Oeste": "Zona da Mata",
  "Santa Luzia D'Oeste": "Zona da Mata",
  "S�o Miguel do Guapor�": "Regi�o da 429",
  "Alvorada D'Oeste": "Regi�o da 429",
  "Seringueiras": "Regi�o da 429",
  "S�o Francisco do Guapor�": "Regi�o da 429",
  "Costa Marques": "Regi�o da 429",
  "Cacoal": "Regi�o do Caf�",
  "Espig�o D'Oeste": "Regi�o do Caf�",
  "Ministro Andreazza": "Regi�o do Caf�",
  "Pimenta Bueno": "Regi�o do Caf�",
  "Primavera de Rond�nia": "Regi�o do Caf�",
  "Jaru": "Bacia Leiteira",
  ...
  "Alto Para�so": "Vale do Jamari",
  "Buritis": "Vale do Jamari",
  "Cacaul�ndia": "Vale do Jamari",
  "Campo Novo de Rond�nia": "Vale do Jamari",
  "Cujubim": "Vale do Jamari",
  "Monte Negro": "Vale do Jamari",
  "Rio Crespo": "Vale do Jamari",
  "Guajar�-Mirim": "P�rola do Mamor�",
  "Nova Mamor�": "P�rola do Mamor�"
};
...
const mapToApp = (row) => {
  ...
  const parseMoney = (val) => {
    ...
    return parseFloat(cleaned.replace(/\./g, '').replace(',', '.')) || 0;
      ...
      let mun = (row['Munic�pio'] || row.municipio || row['Municipio'] || '').trim();
