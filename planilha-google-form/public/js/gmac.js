...
function renderizarGMAC(modulo) {
  ...
  let html = `
    <div class="table-wrap gmac-table-wrap" style="overflow-x: auto !important; overflow-y:auto !important; max-height: calc(100vh - 310px); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; background: rgba(15,23,42,0.6); width:100%; box-sizing:border-box;">
