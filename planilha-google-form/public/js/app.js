        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          ${p.contatos.map(c => {
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;background:rgba(0,0,0,0.02);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">
              ...
              <a href="whatsapp://send?phone=55${numeroLimpo}" class="btn btn-success" style="padding:6px 12px;display:flex;align-items:center;gap:6px;border-radius:6px;font-size:13px;text-decoration:none;border:none">
