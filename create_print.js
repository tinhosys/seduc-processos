...
function imprimirCenso() {
  ...
  allAlunos.forEach(r => {
    ...
    const a1 = Number(r[10]||0);
    const a2 = Number(r[11]||0);
    const a3 = Number(r[12]||0);
    const a4 = Number(r[13]||0);
    const a5 = Number(r[14]||0);
...
fs.writeFileSync('js/print-proalfa.js', printScript, 'utf8');
console.log('js/print-proalfa.js created');
