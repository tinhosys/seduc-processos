...
const replacementBeforePrint = `
    ...
    if (modelo >= 2 && modelo <= 6) {
       ...
       let totalRow = ['TOTAIS', '', '', ''];
       if (modelo === 2) totalRow.push(''); // One more column for 'Detalhe'
...
console.log('Patched totals, description and formatting');
